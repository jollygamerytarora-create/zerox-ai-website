...
/**
 * React Bits — ParticleText (adapted, TypeScript).
 * Text sampled into particles that gather from scatter, repel from
 * the pointer and idle-drift once formed.
 */
export default function ParticleText({
  ...
  useEffect(() => {
    ...
    const startGather = (fromScatter = true) => {
      ...
      // biome-ignore lint/complexity/noForEach: particle loop mutates canvas state sequentially
    ...
    // sleep the particle loop while the tab is hidden; wake on return
    const onVisibility = () => {
      if (document.hidden) {
