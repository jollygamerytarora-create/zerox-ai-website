    ...
    <div
      className={`relative rounded-2xl border transition-all duration-300 overflow-hidden ${
        comingSoon
          ...
          : "border-violet-500/20 bg-slate-900/50 backdrop-blur-md hover:-translate-y-1 hover:border-fuchsia-400/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)]"
      }`}
    >
      ...
      <button
        ...
        className="relative w-full text-left p-6 focus:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-400/60"
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            {comingSoon ? (
              ...
              <>
                <span className="text-xs font-mono text-violet-500/70">
                  {tools.length} tools
                </span>
                <span
      ...
      >
        <div className="px-6 pb-6 border-t border-violet-500/10">
          ...
          <div
            ...
            [&::-webkit-scrollbar-thumb:hover]:bg-fuchsia-400/70"
          >
            {filteredTools.map((tool) => (
              <button
                ...
                className="flex items-center gap-3 w-full text-left px-4 py-3 rounded-xl bg-violet-500/5 border border-violet-500/20 hover:bg-violet-500/15 hover:border-fuchsia-400/50 hover:shadow-[0_0_15px_rgba(168,85,247,0.2)] transition-all duration-200 group"
                data-ocid={`tools.${tool.id}.button`}
              >
                <span className="text-lg">{tool.icon}</span>
                <div>
                  <p className="text-sm font-mono font-semibold text-slate-200 group-hover:text-fuchsia-300 transition-colors">
                    {tool.name}
                  </p>
                ...
                <span className="ml-auto text-violet-500/50 group-hover:text-fuchsia-400 text-xs font-mono transition-colors">
                  OPEN →
                </span>
              </button>
            ))}
