...
export default function Base64Tool() {
  ...
  return (
    <div className="space-y-5 font-mono">
      ...
      <div>
        <span className="text-xs text-fuchsia-400 mb-1 block">Input</span>
        <textarea
          value={input}
      ...
      {output && (
        <div>
          <span className="text-xs text-fuchsia-400 mb-1 block">Output</span>
          <div className="flex items-start gap-2">
            ...
            <button
              type="button"
              onClick={copy}
              className="text-xs text-slate-500 hover:text-fuchsia-300 px-2 pt-2"
            >
              Copy
            </button>
          </div>
