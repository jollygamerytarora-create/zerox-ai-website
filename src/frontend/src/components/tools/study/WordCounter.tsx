...
export default function WordCounter() {
  ...
  return (
    <div className="space-y-5">
      ...
      <textarea
        className="w-full h-40 bg-slate-900/60 border border-violet-500/20 rounded-xl p-4 text-sm text-slate-200 placeholder-slate-600 font-mono resize-none focus:outline-none focus:border-fuchsia-400/60 focus:shadow-[0_0_15px_rgba(168,85,247,0.1)] transition-all"
